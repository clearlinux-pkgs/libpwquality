...
%prep
%setup -q -n libpwquality-1.4.5
cd %{_builddir}/libpwquality-1.4.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697586389
...
cp %{_builddir}/libpwquality-%{version}/COPYING %{buildroot}/usr/share/package-licenses/libpwquality/a01b717e0f402c7a4edeeec8e2afbc961ec72c18 || :
%make_install
