...
Version  : 1.4.3
Release  : 36
URL      : https://github.com/libpwquality/libpwquality/releases/download/libpwquality-1.4.3/libpwquality-1.4.3.tar.bz2
Source0  : https://github.com/libpwquality/libpwquality/releases/download/libpwquality-1.4.3/libpwquality-1.4.3.tar.bz2
...
%prep
%setup -q -n libpwquality-1.4.3
cd %{_builddir}/libpwquality-1.4.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1602549129
...
cp %{_builddir}/libpwquality-1.4.3/COPYING %{buildroot}/usr/share/package-licenses/libpwquality/a01b717e0f402c7a4edeeec8e2afbc961ec72c18
%make_install
